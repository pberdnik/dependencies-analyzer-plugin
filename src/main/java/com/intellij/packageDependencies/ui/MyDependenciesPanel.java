...
public final class MyDependenciesPanel extends JPanel implements Disposable, DataProvider {
  ...
  private final MyDependenciesUsagesPanel myUsagesPanel;
  ...
  private static final Logger LOG = Logger.getInstance(MyDependenciesPanel.class);

  private final boolean myForward;
  private final AnalysisScope myScopeOfInterest;
  private final int myTransitiveBorder;

  public MyDependenciesPanel(Project project, final MyDependenciesBuilder builder){
    this(project, Collections.singletonList(builder), new HashSet<>());
  }

  public MyDependenciesPanel(Project project, final List<MyDependenciesBuilder> builders, final Set<PsiFile> excluded) {
    ...
    exclude(excluded);
    myProject = project;
    myUsagesPanel = new MyDependenciesUsagesPanel(myProject, myBuilders);
  ...
  private final class EditDependencyRulesAction extends AnAction {
    ...
    @Override
    public void actionPerformed(@NotNull AnActionEvent e) {
      boolean applied = ShowSettingsUtil.getInstance().editConfigurable(MyDependenciesPanel.this, new DependencyConfigurable(myProject));
      if (applied) {
        rebuild();
      }
    }
  ...
  private class DependenciesExporterToTextFile implements ExporterToTextFile {
    ...
    public String getReportText() {
      ...
      rootElement.setAttribute("isBackwardYEAH", String.valueOf(!myForward));
  ...
  private final class AddToScopeAction extends AnAction {
    ...
    public void actionPerformed(@NotNull final AnActionEvent e) {
      ...
      final MyDependenciesBuilder builder;
      if (!myForward) {
        builder = new MyBackwardDependenciesBuilder(myProject, scope, myScopeOfInterest);
      } else {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
      ...
      if (leftNode != null && rightNode != null) {
        ...
        if (hasDirectDependencies) {
          ...
          Messages.showErrorDialog(MyDependenciesPanel.this, CodeInsightBundle
