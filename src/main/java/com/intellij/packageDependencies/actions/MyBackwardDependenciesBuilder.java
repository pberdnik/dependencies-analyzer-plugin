...
public class MyBackwardDependenciesBuilder extends MyDependenciesBuilder {
  private final AnalysisScope myForwardScope;
  private final AnalysisScope myScopeOfInterest;

  public MyBackwardDependenciesBuilder(final Project project, final AnalysisScope scope) {
    this(project, scope, null);
  }

  public MyBackwardDependenciesBuilder(final Project project, final AnalysisScope scope, final @Nullable AnalysisScope scopeOfInterest) {
    super(project, scope);
  ...
  @Override
  public void analyze() {
    final MyDependenciesBuilder builder = new MyForwardDependenciesBuilder(getProject(), myForwardScope);
  ...
  private static void subtractScope(final MyDependenciesBuilder builders, final AnalysisScope scope) {
