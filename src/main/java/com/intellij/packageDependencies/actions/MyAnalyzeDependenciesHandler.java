...
public class MyAnalyzeDependenciesHandler extends MyDependenciesHandlerBase {
  private final int myTransitiveBorder;

  public MyAnalyzeDependenciesHandler(@NotNull Project project, List<? extends AnalysisScope> scopes, int transitiveBorder, Set<PsiFile> excluded) {
    super(project, scopes, excluded);
    myTransitiveBorder = transitiveBorder;
  }

  public MyAnalyzeDependenciesHandler(final Project project, final AnalysisScope scope, final int transitiveBorder) {
    this(project, Collections.singletonList(scope), transitiveBorder, new HashSet<>());
  }

  @Override
  protected MyDependenciesBuilder createDependenciesBuilder(AnalysisScope scope) {
