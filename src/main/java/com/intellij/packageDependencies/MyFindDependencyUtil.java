...
public final class MyFindDependencyUtil {
  private MyFindDependencyUtil() {}

  public static UsageInfo[] findDependencies(@Nullable final List<? extends MyDependenciesBuilder> builders, Set<? extends PsiFile> searchIn, Set<? extends PsiFile> searchFor) {
  ...
  public static UsageInfo[] findBackwardDependencies(final List<? extends MyDependenciesBuilder> builders, final Set<? extends PsiFile> searchIn, final Set<? extends PsiFile> searchFor) {
    final List<UsageInfo> usages = new ArrayList<>();
    ProgressIndicator indicator = ProgressManager.getInstance().getProgressIndicator();
  ...
  private static void analyzeFileDependencies(PsiFile psiFile, final Set<? extends PsiFile> searchFor, final List<? super UsageInfo> result) {
    MyDependenciesBuilder.analyzeFileDependencies(psiFile, (place, dependency) -> {
  ...
  public static UsageInfo[] findDependencies(final MyDependenciesBuilder builder, final Set<? extends PsiFile> searchIn, final Set<? extends PsiFile> searchFor) {
    return findDependencies(Collections.singletonList(builder), searchIn, searchFor);
  }

  public static UsageInfo[] findBackwardDependencies(final MyDependenciesBuilder builder, final Set<? extends PsiFile> searchIn, final Set<? extends PsiFile> searchFor) {
